    ...
    const address = await prisma.$transaction(async (tx) => {
        ...
        return tx.address.create({
            data: {
                ...
                province: parsedInput.province ?? null,
                barangay: parsedInput.barangay ?? null,
    ...
    const address = await prisma.$transaction(async (tx) => {
        ...
        return tx.address.update({
            ...
            data: {
                ...
                ...(parsedInput.province && { province: parsedInput.province }),
                ...(parsedInput.barangay && { barangay: parsedInput.barangay }),
