...
function buildSKU(category, variants, name) {
...
export async function generateProductSKU(input) {
    ...
    do {
        sku = buildSKU(input.category, input.variants, input.name);
...
export async function generateVariantSKU(input) {
...
export async function generateOptionValues(optionName) {
    const systemPrompt = `
...
//# sourceMappingURL=GenerateService.js.map